	--easy script configs
    IntroTextSize = 10	--Size of the text for the Now Playing thing.
    IntroSubTextSize = 20 --size of the text for the Song Name.
    IntroSubText2Size = 20
    IntroTagColor = '9900ff' --Color of the tag at the end of the box.
    IntroTagWidth = 30	--Width of the box's tag thingy.
    --easy script configs
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Frostbite (Rei Cover/Remix)', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'IamSolarDreemurr', 300, -305-IntroTagWidth, 260)
